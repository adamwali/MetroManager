...
export const EVENT_TEMPLATES: EventTemplate[] = [
  ...
  // EV057-060 removed in Phase 10.10 — never fired in 750 playtest runs.
  // NIMBY chain (057/058/059) had thresholds ≥40/55/70 that the gauge
  // (capped ~25 in normal play) never reached. EV060 hostile consultant
  // op-ed required alignment ≤-40 that bots/players rarely hit.
